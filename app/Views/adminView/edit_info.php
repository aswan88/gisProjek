...
<div class="container p-5">
    ...
    <form action="/admin/saveEdit_info" method="post">
        ...
        <div class="form-group row">
            ...
            <input type="hidden" name="id_info" value="<?= $dataInfo['id_info']; ?>">
        </div>
        ...
        <div class="form-group row">
            <input type="text" class="form-control w-100" id="luas_wilayah" name="luas_wilayah" value="<?= $dataInfo['luas_wilayah']; ?>" required>
        </div>
        ...
        <div class="form-group row">
            <input type="text" class="form-control w-100" id="jumlah_pend" name="jumlah_pend" value="<?= $dataInfo['jumlah_pend']; ?>" required>
        </div>
        <div class="form-group row">
            <label for="info_lengkap" class="col-form-label font-weight-bold ">Informasi lengkap <span class="text-danger">*</span></label>
        </div>
        <div class="form-group row">
            <textarea name="info_lengkap" id="info_lengkap" class="form-control">
            <?= $dataInfo['info_lengkap']; ?>
            </textarea>
        </div>
